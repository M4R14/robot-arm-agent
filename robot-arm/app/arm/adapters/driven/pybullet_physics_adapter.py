...
engine. A driven adapter (Hexagonal / Ports & Adapters): implements
domain.ports.ArmPhysicsPort structurally — the domain code that consumes
it never imports `pybullet` or this module directly, only the Port.
...
from ...domain.ports import JointAngle
